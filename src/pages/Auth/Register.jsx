        ...
        <div className="flex justify-center items-center h-screen bg-gray-100">
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <div>
                        <label htmlFor="password_confirmation" className="block font-semibold">Konfirmasi Password</label>
                        <input
                            type="password"
                    ...
                    <div>
                        <button
                            type="submit"
                            className={`w-full bg-green-700 text-white py-2 rounded-md hover:bg-green-800 transition ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                            disabled={loading}
                        >
                    ...
                    <div className="text-center mt-4">
                        <a href="/login" className="text-blue-500 hover:underline">Sudah punya akun? Login</a>
                    </div>
                </form>
            </div>
        </div>
